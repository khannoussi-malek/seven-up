...
import "/home/rami/Desktop/seven-up/seven-up/src/component/tips/Tips.css"
    ...
    return (
        ...
        <div className='container'>
            <div className='tips'>
                ...
                <div className='tips-heading heading-section'>
                    Some Tips
                </div>
                ...
                <div className='tips-container'>
                    ...
                    <div className='tips-left-side'>
                        ...
                        <div className={`${righto} heading-right `}>Tip {SomeTipsData[selected].type}</div>
                    ...
                    <div className='tips-right-side'>
                        <div className='img-left-container'>
                            ...
                            <img src={SomeTipsData[selected].image} alt="slide" className={`${lefto}`} />
                            <div className='arrows'>
                                <img src="./Assets/leftArrow.png" alt="left" onClick={handleLeftArrow} />
                                <img src="./Assets/rightArrow.png" alt="right" onClick={handleRightArrow} />
                            </div>
                        </div>
